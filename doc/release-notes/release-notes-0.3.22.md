Download URL: https://sourceforge.net/projects/filbit/files/Filbit/filbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FBT fee schedule (users still pay 0.01 FBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #filbit00 - #filbit99
