Filbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/filbit/files/Filbit/filbit-0.5.4/
...
http://gitorious.org/filbit/filbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Filbit-Qt notifications under Growl 1.3.
Increase required age of Filbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFilbit properly when installing Filbit-Qt over it. (Windows)
