Filbit Core version 0.9.2.1 is now available from:

  https://filbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FBT to 0.01 FBT
...
- Fix "Start filbit on system login"
