Filbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/filbit/files/Filbit/filbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Filbit
...
New/changed settings (command-line or filbit.conf file)
--------------------------------------------------------
