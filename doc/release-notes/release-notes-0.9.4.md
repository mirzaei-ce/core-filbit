Filbit Core version 0.9.4 is now available from:

  https://filbit.org/bin/0.9.4/
...
this update is incompatible with the Filbit system and could lead to consensus
forks.

Filbit Core released binaries from https://filbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~filbit/+archive/ubuntu/filbit
- A third-party or self-compiled Filbit Core

upgrade to Filbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
