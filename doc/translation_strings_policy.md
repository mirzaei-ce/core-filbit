...
This document provides guidelines for internationalization of the Filbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `filbit_en.ts` remains unchanged.
