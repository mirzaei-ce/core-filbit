# mininode.py - Filbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a filbit node
...
# Objects that map to filbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in filbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Filbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
