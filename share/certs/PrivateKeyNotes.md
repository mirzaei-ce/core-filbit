...
unlocked to sign the Filbit-Qt.app bundle.
...
allowing somebody to distribute a Filbit-Qt.app or filbit-qt-setup.exe with a valid
...
that the filbit-qt.exe file inside the installer had not been tampered with.
