...
#if defined(NDEBUG)
# error "Filbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Filbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s FBT additional fees, %d delta bytes\n",
