...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CFilbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CFilbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CFilbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CFilbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CFilbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFilbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
