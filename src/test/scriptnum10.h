...
#ifndef FILBIT_TEST_SCRIPTNUM10_H
#define FILBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Filbit Core 0.10.0, for cross-comparison.
 */
public:
