...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/filbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Filbit Core"),
     ...
     * override -datadir in the filbit.conf file in the default data directory
     * (to be consistent with filbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
