...
#ifndef FILBIT_QT_FILBITUNITS_H
#define FILBIT_QT_FILBITUNITS_H
...
/** Filbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FilbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FilbitUnits(QObject *parent);

    /** Filbit units.
      @note Source: https://en.filbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FBT,
...
typedef FilbitUnits::Unit FilbitUnit;

#endif // FILBIT_QT_FILBITUNITS_H
