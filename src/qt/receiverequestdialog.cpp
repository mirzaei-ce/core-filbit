...
#include "config/filbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFilbitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FilbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFilbitURI(info));
}
